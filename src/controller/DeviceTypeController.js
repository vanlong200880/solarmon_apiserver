...
import DeviceTypeEntity from '../entities/DeviceTypeEntity';
import DeviceTypeService from '../services/DeviceTypeService';
import DeviceTypeValidate from '../validator/DeviceTypeValidate';
import Sync from 'sync';

class DeviceTypeController extends AbstractManagerController {
    ...
    getList(res, postData) {
        try {
            let service = new DeviceTypeService();
            let entity = new DeviceTypeEntity();
    ...
    getDetail(res, postData) {
        try {
            var service = new DeviceTypeService();
            let entity = new DeviceTypeEntity();
            entity = Object.assign({}, entity, postData);
     ...
     * @param {*} postData 
     */
    async deleteAction(res, postData) {
        try {
            let service = new DeviceTypeService();
            let entity = new DeviceTypeEntity();
            entity = Object.assign({}, entity, postData);
            ...
            // Check exits
            let DeviceTypeUse = await service.checkExistDeviceTypeUse(entity);
     ...
     */
     async saveAction(res, postData) {
        try {
            let service = new DeviceTypeService();
            let entity = Object.assign({}, new DeviceTypeEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;
            let validate = new DeviceTypeValidate();
