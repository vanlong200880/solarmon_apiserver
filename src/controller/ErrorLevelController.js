...
import ErrorLevelEntity from '../entities/ErrorLevelEntity';
import ErrorLevelService from '../services/ErrorLevelService';
import ErrorLevelValidate from '../validator/ErrorLevelValidate';
import Sync from 'sync';

class ErrorLevelController extends AbstractManagerController {
    ...
    getList(res, postData) {
        try {
            let service = new ErrorLevelService();
            let entity = new ErrorLevelEntity();
    ...
    getDetail(res, postData) {
        try {
            var service = new ErrorLevelService();
            let entity = new ErrorLevelEntity();
            entity = Object.assign({}, entity, postData);
    ...
    updateStatus(res, postData) {
        try {
            let service = new ErrorLevelService();
            let entity = Object.assign({}, new ErrorLevelEntity(), postData);
    ...
    async saveAction(res, postData) {
        try {
            ...
            let entity = Object.assign({}, new ErrorLevelEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;
            let validate = new ErrorLevelValidate();
...
export default ErrorLevelController;