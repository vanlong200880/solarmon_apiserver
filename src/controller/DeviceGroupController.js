...
import DeviceGroupEntity from '../entities/DeviceGroupEntity';
import DeviceGroupService from '../services/DeviceGroupService';
import DeviceGroupValidate from '../validator/DeviceGroupValidate';
import Sync from 'sync';

class DeviceGroupController extends AbstractManagerController {
    ...
    getList(res, postData) {
        try {
            let service = new DeviceGroupService();
            let entity = new DeviceGroupEntity();
    ...
    getDetail(res, postData) {
        try {
            var service = new DeviceGroupService();
            let entity = new DeviceGroupEntity();
            entity = Object.assign({}, entity, postData);
     ...
     */
     async saveAction(res, postData) {
        try {
            let service = new DeviceGroupService();
            let entity = Object.assign({}, new DeviceGroupEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;

            let validate = new DeviceGroupValidate();
...
export default DeviceGroupController;