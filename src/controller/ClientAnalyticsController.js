...
class ClientAnalyticsController extends BaseController {
    constructor() {
        super();
    }
     ...
     */
     getDataChartProfile(res, postData) {
        try {
            var service = new ClientAnalyticsService();
	 ...
	 */
     getListDeviceByProject(res, postData) {
        try {
            let service = new ClientAnalyticsService();
            let entity = new ProjectEntity();
            entity = Object.assign({}, entity, postData);
...
export default ClientAnalyticsController;