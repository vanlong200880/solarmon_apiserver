...
import ErrorValidate from '../validator/ErrorValidate';
import Sync from 'sync';

class ErrorController extends AbstractManagerController {
    ...
    getList(res, postData) {
        try {
            let service = new ErrorService();
            let entity = new ErrorEntity();
    ...
    updateStatus(res, postData) {
        try {
            let service = new ErrorService();
            let entity = Object.assign({}, new ErrorEntity(), postData);
    ...
    async saveAction(res, postData) {
        try {
            ...
            let entity = Object.assign({}, new ErrorEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;
            let validate = new ErrorValidate();
