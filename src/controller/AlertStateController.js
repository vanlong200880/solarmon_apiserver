...
import AlertStateEntity from '../entities/AlertStateEntity';
import AlertStateService from '../services/AlertStateService';
import AlertStateValidate from '../validator/AlertStateValidate';
import Sync from 'sync';

class AlertStateController extends AbstractManagerController {
    ...
    getList(res, postData) {
        try {
            let service = new AlertStateService();
            let entity = new AlertStateEntity();
    ...
    updateStatus(res, postData) {
        try {
            let service = new AlertStateService();
            let entity = Object.assign({}, new AlertStateEntity(), postData);
    ...
    async saveAction(res, postData) {
        try {
            ...
            let entity = Object.assign({}, new AlertStateEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;
            let validate = new AlertStateValidate();
...
export default AlertStateController;