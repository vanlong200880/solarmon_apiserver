...
import RoleValidate from '../validator/RoleValidate';
import Sync from 'sync';

class RoleController extends AbstractManagerController {
     ...
     */
     async saveAction(res, postData) {
        try {
            let service = new RoleService();
            let entity = Object.assign({}, new RoleEntity(), postData);
            entity.status = (!entity.status || entity.status == -1) ? 0 : 1;
            let validate = new RoleValidate();
	 ...
	 * @param {*} postData 
	 */
     getListScreenPermissions(res, postData) {
        try {
            let service = new RoleService();
            let entity = new RoleEntity();
            entity = Object.assign({}, entity, postData);
     ...
     * @param {*} postData 
     */
      updateRolePermissions(res, postData) {
        try {
            let service = new RoleService();
            let entity = Object.assign({}, new RoleEntity(), postData);
            Sync(function () {
     ...
     * @param {*} postData 
     */
     async updateRoleMapScreen(res, postData) {
        try {
            let service = new RoleService();
            let entity = Object.assign({}, new RoleEntity(), postData);
